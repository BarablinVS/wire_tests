...
print ("{0:^100}".format("EstablishmentReject_2") + "\n")
...
e.populate("Credentials", 'Many_IP')
...
def on(message):
    ...
    if ("EstablishmentReject(blockLength=9, templateId=5002, schemaId=19781, version=1, RequestTimestamp=1454056522056416880, EstablishmentRejectCode=2)" == str(message)):
        print("\n" + "TEST 1 OK")
    else:
        print("\n" + "TEST 1 FAIL")
